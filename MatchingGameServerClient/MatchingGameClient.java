...
public class MatchingGameClient implements ActionListener{
   ...
   private Scanner in; //scanner
    ...
    public MatchingGameClient(String serverAddress) throws Exception {

         socket = new Socket(serverAddress , 16789); //will be a localhost for now
   ...
   public void message(){
      try{
         socket = new Socket("localhost", 16789); //localhost for now
   ...
   public void getIcon(int inPosition){
    ...
    public static void main(String[] args) throws Exception {
        MatchingGameClient client = new MatchingGameClient("localhost");
        client.message();
    }//main
}